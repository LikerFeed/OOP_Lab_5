    ...
    case WM_COMMAND:
        {
            ...
            case IDM_ELLIPSE:
                editor->Start(new EllipseShape, hWnd, ID_TOOL_ELLIPSE, IDM_ELLIPSE, lParam);
                break;

            case ID_TOOL_POINTPLUS:
            case IDM_POINTPLUS:
                editor->Start(new PointPlusShape, hWnd, ID_TOOL_POINTPLUS, IDM_POINTPLUS, lParam);
                break;
            ...
            case ID_TOOL_LINEOO:
            case IDM_LINEOO:
                editor->Start(new LineOOShape, hWnd, ID_TOOL_LINEOO, IDM_LINEOO, lParam);
                break;
